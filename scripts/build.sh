#!/usr/bin/env bash
# build.sh - Build mcpyeahyouknowme binary
# =========================================
#
# Description:
#   Compiles the Go application and embeds build metadata (timestamp and version).
#
# Output:
#   Creates mcpyeahyouknowme.bin in repo root
#
# Usage:
