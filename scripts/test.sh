...
# ── Step 1: Filter coverage.txt to core business logic files ──
# Exclude CLI handlers, OAuth flows, event handlers, and daemon code.
# Then remove specific uncovered statements that are:
